...
let firstLast = people.map(people => {
...
const lifespan = inventors.passed - inventors.year
...
let travelMethodCounts = travelMethods.reduce((accumulator, travelMethods) => {
  if (accumulator[travelMethods]) {
    accumulator[travelMethods]++
  } else {
    accumulator[travelMethods] = 1
  }
  return accumulator
}, {})
